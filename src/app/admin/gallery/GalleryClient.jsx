    ...
    <div className="an">
      <div className="an__bar">
        <div className="an__bar-left">
          <h1 className="an__title">포토갤러리 관리</h1>
          <p className="an__sub">갤러리 게시물을 작성·수정·삭제할 수 있습니다.</p>
        </div>
        <Link href="/admin/gallery/new" className="an-btn an-btn--primary">
        ...
        <table className="an-table">
          <thead>
            <tr>
              ...
              <th className="an-table__th" style={{ width: '3.5rem' }}>썸네일</th>
            ...
            {posts.length === 0 && (
              <tr>
                <td className="an-table__empty" colSpan={6}>
                  게시물이 없습니다.{' '}
                  <Link href="/admin/gallery/new" className="an-table__empty-link">새 게시물을 작성해 보세요.</Link>
                </td>
              </tr>
            )}
          </tbody>
